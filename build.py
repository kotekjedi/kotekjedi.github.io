...
def get_personal_data():
    ...
    bio_text = f"""
        <img src="assets/img/profile_mine.jpg" alt="Profile picture" class="profile-pic img-fluid" style="float: right; margin-left: 35px; margin-bottom: 15px; margin-right: -85px;">
